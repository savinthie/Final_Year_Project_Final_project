...
const n_members = single_parent === 1 ? n_children + 1 : n_children + 2;
  ...
  return (
    ...
    <div className="App">
      ...
      <h1 id= "smartfinHeader">Household Expenditure Prediction</h1>
        ...
        <div className="results-container">
          <table className="results-table">
            ...
            <tbody>
              <tr>
                <td>Housing</td>
                <td>${results.Housing?.toFixed(2)}</td>
              </tr>
              <tr>
                <td>Food</td>
                <td>${results.Food?.toFixed(2)}</td>
              </tr>
              <tr>
                <td>Transportation</td>
                <td>${results.Transportation?.toFixed(2)}</td>
              </tr>
              <tr>
                <td>Healthcare</td>
                <td>${results.Healthcare?.toFixed(2)}</td>
              </tr>
              <tr>
                <td>Childcare</td>
                <td>${results.Childcare?.toFixed(2)}</td>
              </tr>
              <tr>
                <td>Taxes</td>
              ...
              <tr>
                ...
                <td>${results.OtherNecessities?.toFixed(2)}</td>
              </tr>
